...
namespace Timers
{
    ...
    public class Timer
    {
        ...
        [SerializeField] private bool m_InfiniteLoops = false;

        [SerializeField] [Range(1, 10000)] private uint m_LoopsCount = 1;

        [SerializeField] private UnityEvent m_Event = null;

        public UnityAction<float> m_Progrress = null;
        ...
        internal void UpdateTimer()
        {
            ...
            else
            {
                ...
                m_Progrress?.Invoke(m_CurrentCycleElapsedTime);
        ...
        {
            return m_LoopsCount - m_CurrentLoopsCount;
        }
        ...
        {
            return (m_LoopsCount == INFINITE) ? INFINITE : (m_LoopsCount * m_Interval);
        }
        ...
        {
            return (m_LoopsCount == INFINITE && m_Interval > 0f) ? INFINITE : Mathf.Max(m_LoopsCount * m_Interval - m_ElapsedTime, 0f);
        }
        ...
        {
            return m_CurrentCycleElapsedTime;
        }
        ...
        {
            return Mathf.Max(m_Interval - m_CurrentCycleElapsedTime, 0);
        }
        ...
        {
            return (m_Delegate == null || RemainingTime() == 0);
        }
